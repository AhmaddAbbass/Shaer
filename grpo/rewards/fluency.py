...
def score_fluency(generated_poem: str, prompt_file: str, cache_dir: str):
...
def make_fluency_reward(run_dir: str, prompt_file: str, cache_dir: str):
    debug_path = f"{run_dir}/reward_fluency_debug.jsonl"
    ...
    def reward_fn(prompts=None, completions=None, **kwargs):
        ...
        for i, completion in enumerate(completions):
            ...
            out = score_fluency(poem, prompt_file=prompt_file, cache_dir=cache_dir)
