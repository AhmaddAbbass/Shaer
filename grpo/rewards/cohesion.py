...
def score_cohesion(generated_poem: str, prompt_file: str, cache_dir: str):
...
def make_cohesion_reward(run_dir: str, prompt_file: str, cache_dir: str):
    debug_path = f"{run_dir}/reward_cohesion_debug.jsonl"
    ...
    def reward_fn(prompts=None, completions=None, **kwargs):
        ...
        for i, completion in enumerate(completions):
            ...
            out = score_cohesion(poem, prompt_file=prompt_file, cache_dir=cache_dir)
